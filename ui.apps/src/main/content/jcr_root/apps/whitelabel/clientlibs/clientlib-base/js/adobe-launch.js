...
const locale = parts[1]; // the first path element after the initial empty string
...
(function() {
  var elem = Array.from(document.querySelectorAll('body > div')).filter(divElem =>divElem.getAttribute('data-propid')!== null)[0];
  if (elem != null) {
