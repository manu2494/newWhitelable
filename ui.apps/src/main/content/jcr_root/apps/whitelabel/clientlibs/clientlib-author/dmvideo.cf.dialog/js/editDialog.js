...
(function(window, $, channel, Granite, Coral) {
    ...
    var CLASS_EDIT_DIALOG = "cmp-dmvideo-contentfragment__editor";

    // field selectors
    var SELECTOR_FRAGMENT_PATH = "[name='./cfPath']";
    var SELECTOR_ELEMENT_NAMES_CONTAINER = "[data-element-names-container='true']";
    var SELECTOR_ELEMENT_NAMES = "[data-granite-coral-multifield-name='./cfElement']";
    ...
    ElementsController.prototype.testGetHTML = function(callback) {
        ...
        $.when(elementNamesRequest).then(function(result1) {
            var newSingleTextSelector = $(result1).find(SELECTOR_SINGLE_TEXT_ELEMENT)[0];
