...
class SeoSiteOrganizationWithSearchActionTest {
  ...
  void test_component_with_empty_config() {
    SeoSiteOrganizationWithSearchAction seoSiteOrganizationWithSearchAction = new SeoSiteOrganizationWithSearchAction(seoSiteOrganizationConfig);
    seoSiteOrganizationWithSearchAction.setPotentialAction(Collections.emptyList());
