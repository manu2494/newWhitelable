...
class SeoArticleAuthorTest {
  ...
  public void setup() throws Exception {
    ...
    context.currentResource(context.resourceResolver().getResource(PAGE + "/jcr:content/schema/article/author"));
  }

  @Test
  void test_component() {
    SeoArticleAuthor seoArticleAuthor = context.currentResource().adaptTo(SeoArticleAuthor.class);

    assertNotNull(seoArticleAuthor.getName());
    assertNotNull(seoArticleAuthor.getType());
  }
